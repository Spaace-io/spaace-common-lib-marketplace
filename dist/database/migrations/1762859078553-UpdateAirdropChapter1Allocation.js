...
exports.Migrations1762859078553 = void 0;
class Migrations1762859078553 {
    constructor() {
        this.name = 'Migrations1762859078553';
    }
    up(queryRunner) {
    ...
    `);
            // Reset sequences
            yield queryRunner.query(`SELECT setval('airdrop_chests_chapter1_id_seq', 1, false)`);
            yield queryRunner.query(`SELECT setval('airdrop_tiers_chapter1_id_seq', 1, false)`);
    ...
    `);
      ...
      (20, 'B4', 0, 5)
    `);
            yield queryRunner.query(`SELECT setval('airdrop_tiers_chapter1_id_seq', 20, true)`);
...
exports.Migrations1762859078553 = Migrations1762859078553;
//# sourceMappingURL=1762859078553-UpdateAirdropChapter1Allocation.js.map