...
exports.SeedInitialBadges1768200000002 = void 0;
class SeedInitialBadges1768200000002 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            // 1. OG Badge
            const [ogBadge] = yield queryRunner.query(`
    ...
    `, [ogBadge.id]);
            // 2. Gm Badge
            const [gmBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [gmBadge.id]);
            // 3. Collector Badge
            const [collectorBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [collectorBadge.id]);
            ...
            const [loyalCollectorBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [loyalCollectorBadge.id]);
            // 5. Fanatic Badge
            const [fanaticBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [fanaticBadge.id]);
            ...
            const [collectorManiacBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [collectorManiacBadge.id]);
            // 7. Volume God Badge
            const [volumeGodBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [volumeGodBadge.id]);
            // 8. Lister Lord Badge
            const [listerLordBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [listerLordBadge.id]);
            ...
            const [sellerMasterBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [sellerMasterBadge.id]);
            // 10. Prescriber Badge
            const [prescriberBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
    ...
    `, [prescriberBadge.id]);
            // 11. Loyal Badge
            const [loyalBadge] = yield queryRunner.query(`
      INSERT INTO "badges" (code, category, name, description, is_repeatable, max_count, sort_order, rarity)
...
exports.SeedInitialBadges1768200000002 = SeedInitialBadges1768200000002;
//# sourceMappingURL=1768200000002-SeedInitialBadges.js.map