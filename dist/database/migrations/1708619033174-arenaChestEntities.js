...
class ArenaChestEntities1708619033174 {
    ...
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "arena_crews" ("level" numeric(78) NOT NULL DEFAULT '0', "stars" numeric(78) NOT NULL DEFAULT '0', "min" numeric(78) NOT NULL DEFAULT '0', "max" numeric(78) NOT NULL DEFAULT '0', CONSTRAINT "PK_c474ea51ae5c4e0507c23bc9cf3" PRIMARY KEY ("level"))`);
