...
exports.QuestAudit1771002349822 = void 0;
class QuestAudit1771002349822 {
    constructor() {
        this.name = 'QuestAudit1771002349822';
    }
    up(queryRunner) {
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qav_status_created_id";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qav_quest_created_id";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qav_user_created_id";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qav_eventId";`);
            yield queryRunner.query(`DROP TABLE IF EXISTS "quest_audit_evaluations";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ux_qae_user_trigger_orderhash";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ux_qae_user_tx_log";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qae_orderhash";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qae_tx_log";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qae_user_processed_id";`);
            yield queryRunner.query(`DROP INDEX IF EXISTS "ix_qae_user_occurred_id";`);
            yield queryRunner.query(`DROP TABLE IF EXISTS "quest_audit_events";`);
            yield queryRunner.query(`
      DO $$
      BEGIN
...
exports.QuestAudit1771002349822 = QuestAudit1771002349822;
//# sourceMappingURL=1771002349822-QuestAudit.js.map