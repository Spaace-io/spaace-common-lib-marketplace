...
exports.Migrations1763133781574 = void 0;
class Migrations1763133781574 {
    constructor() {
        this.name = 'Migrations1763133781574';
    }
    up(queryRunner) {
  ...
  `);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`DROP TABLE "airdrop_tiers_delivery_rules_opensea_chapter1"`);
            yield queryRunner.query(`DROP TABLE "airdrop_tiers_opensea_chapter1"`);
...
exports.Migrations1763133781574 = Migrations1763133781574;
//# sourceMappingURL=1763133781574-airdrop_opensea_chapter1.js.map