...
exports.CreateBadgeSystem1768200000001 = void 0;
class CreateBadgeSystem1768200000001 {
    up(queryRunner) {
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`DROP TABLE IF EXISTS "badge_unlock_history" CASCADE`);
            yield queryRunner.query(`DROP TABLE IF EXISTS "user_featured_badges" CASCADE`);
            yield queryRunner.query(`DROP TABLE IF EXISTS "user_badges" CASCADE`);
            yield queryRunner.query(`DROP TABLE IF EXISTS "badge_conditions" CASCADE`);
            yield queryRunner.query(`DROP TABLE IF EXISTS "badges" CASCADE`);
            // Drop enums with CASCADE
            yield queryRunner.query(`DROP TYPE IF EXISTS "public"."badge_status" CASCADE`);
            yield queryRunner.query(`DROP TYPE IF EXISTS "public"."badge_condition_type" CASCADE`);
            yield queryRunner.query(`DROP TYPE IF EXISTS "public"."badge_rarity" CASCADE`);
            yield queryRunner.query(`DROP TYPE IF EXISTS "public"."badge_category" CASCADE`);
        });
    }
}
exports.CreateBadgeSystem1768200000001 = CreateBadgeSystem1768200000001;
//# sourceMappingURL=1768200000001-CreateBadgeSystem.js.map