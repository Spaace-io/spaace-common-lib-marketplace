...
exports.BitcoinTypeAddedInWowChest1713608494023 = void 0;
class BitcoinTypeAddedInWowChest1713608494023 {
    constructor() {
        this.name = 'BitcoinTypeAddedInWowChest1713608494023';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TYPE "public"."arena_wow_chest_type" AS ENUM('XP', 'TOKEN', 'BOOSTER', 'EMPTY', 'BITCOIN')`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "arena_wow_chest_probability" DROP CONSTRAINT "UQ_8ec460bf8a57510890cd60fbed2"`);
            yield queryRunner.query(`ALTER TABLE "arena_wow_chest_probability" ALTER COLUMN "probability" SET DEFAULT 0.00`);
            yield queryRunner.query(`CREATE TYPE "public"."arena_wow_chest_type_old" AS ENUM('XP', 'TOKEN', 'BOOSTER', 'EMPTY')`);
...
exports.BitcoinTypeAddedInWowChest1713608494023 = BitcoinTypeAddedInWowChest1713608494023;
//# sourceMappingURL=1713608494023-bitcoinTypeAddedInWowChest.js.map