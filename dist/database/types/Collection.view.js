    ...
    (0, typeorm_1.ViewEntity)({
        expression: (dataSource) => {
            return dataSource
                ...
                .addSelect('COALESCE("ranking"."previousSaleCount1h", 0)', 'previousSaleCount1h')
                .addSelect('COALESCE("ranking"."previousSaleCount6h", 0)', 'previousSaleCount6h')
                .addSelect('COALESCE("ranking"."previousSaleCount24h", 0)', 'previousSaleCount24h')
                .addSelect('COALESCE("ranking"."previousSaleCount7d", 0)', 'previousSaleCount7d')
                .addSelect('COALESCE("ranking"."previousSaleCount30d", 0)', 'previousSaleCount30d')
                .addSelect('COALESCE("ranking"."previousSaleCount90d", 0)', 'previousSaleCount90d')
