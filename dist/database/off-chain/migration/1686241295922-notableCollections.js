...
class notableCollections1686241295922 {
    ...
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "collection"`);
            yield queryRunner.query(`ALTER TABLE "orders" ADD "collection" character(40) NOT NULL`);
        });
    }
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "collection"`);
            yield queryRunner.query(`ALTER TABLE "orders" ADD "collection" character varying NOT NULL`);
