...
export class init1670602246178 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "collections" ("id" character varying NOT NULL, "deployedOwner" character varying, "name" character varying, "countOwner" character varying, "symbol" character varying, "totalSupply" integer, "tokenType" character varying, "abi" jsonb, "imageUrl" character varying, "active" boolean NOT NULL DEFAULT true, "verified" boolean NOT NULL DEFAULT false, "explicit" boolean NOT NULL DEFAULT false, "bannerUrl" character varying, "description" character varying, "highOffer" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_21c00b1ebbd41ba1354242c5c4e" PRIMARY KEY ("id"))`);
