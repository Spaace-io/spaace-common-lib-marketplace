...
export class updateItem1671152671230 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "items" ADD CONSTRAINT "PK_61b73312456c4f25a9f4102ea45" PRIMARY KEY ("tokenId")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "collections" DROP COLUMN "deployedOwner"`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" DROP COLUMN "countOwner"`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" DROP COLUMN "totalSupply"`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" DROP COLUMN "highOffer"`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" DROP COLUMN "updated_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD "collection" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" DROP CONSTRAINT "PK_61b73312456c4f25a9f4102ea45"`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD CONSTRAINT "PK_6e28cea27b3667af77a587ef45b" PRIMARY KEY ("tokenId", "collection")`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "address" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD CONSTRAINT "PK_6a20f6af50eaccf584e5e2a9a6a" PRIMARY KEY ("address")`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "deployer" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "highOffer" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "totalSupply" integer`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "countOwner" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "deployedOwner" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "collections" ADD "id" character varying NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "items" ADD "collectionId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD "updated_at" TIMESTAMP DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD "created_at" TIMESTAMP DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD "lastTimeUpdate" TIMESTAMP`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD "isRefreshed" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" DROP CONSTRAINT "PK_61b73312456c4f25a9f4102ea45"`,
    );
