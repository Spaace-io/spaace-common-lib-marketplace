...
export class ArenaUser1708337359691 implements MigrationInterface {
  name = 'ArenaUser1708337359691';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "arena_users" ("twitterUsername" text NOT NULL, "name" text, "imageUrl" text, "referrerUsername" text, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5369e233e18e92fecb08b7991a5" PRIMARY KEY ("twitterUsername"))`,
    );
    await queryRunner.query(
