...
export class Migrations1759311896989 implements MigrationInterface {
  name = 'Migrations1759311896989';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "users" RENAME COLUMN "checkedAirdropS1" TO "checkedAirdropChapter0"`,
    );

    await queryRunner.query(
      `ALTER TABLE "users" ADD "checkedAirdropChapter1" boolean NOT NULL DEFAULT false`,
    );
  ...
  `);
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_airdrop_users_chapter1_address" ON "airdrop_users_chapter1" ("address")`,
    );
  ...
  `);
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_airdrop_users_chests_chapter1_address" ON "airdrop_users_chests_chapter1" ("address")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "airdrop_chests_type_chapter1"`);

    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN "checkedAirdropChapter1"`,
    );
  }
}
