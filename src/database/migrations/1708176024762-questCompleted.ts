...
export class QuestCompleted1708176024762 implements MigrationInterface {
  name = 'QuestCompleted1708176024762';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_loyalties" ADD "questCompleted" bigint NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP VIEW "balances_view"`);
    await queryRunner.query(
      `ALTER TABLE "user_loyalties" DROP COLUMN "questCompleted"`,
    );
    await queryRunner.query(
