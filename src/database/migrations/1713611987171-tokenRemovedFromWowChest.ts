...
export class TokenRemovedFromWowChest1713611987171
  implements MigrationInterface
{
  name = 'TokenRemovedFromWowChest1713611987171';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."arena_wow_chest_type_old" AS ENUM('XP', 'TOKEN', 'BOOSTER', 'EMPTY', 'BITCOIN')`,
    );
    await queryRunner.query(
