...
export class updateOrder1673008202307 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "hash" character(64) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "PK_13ab9c024e81573c05451b9004f" PRIMARY KEY ("hash")`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "tokenId" character varying`);
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "user" SET NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "user" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "tokenId"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "PK_13ab9c024e81573c05451b9004f"`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "item" character varying`);
